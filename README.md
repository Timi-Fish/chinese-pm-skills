...
> Product-manager skills for AI coding agents (Claude Code / Codex / Gemini CLI): competitor teardown → requirement evaluation (KANO/RICE) → PRD writing → tracking plan, with human-in-the-loop gates. Written in Chinese.
